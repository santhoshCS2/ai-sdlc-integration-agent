...
class LLMAnalyzer:
    ...
    async def async_analyze_code_files(self, file_contents, repo_url, prd_content=None):
        """Async wrapper for code analysis"""
        import asyncio
        loop = asyncio.get_event_loop()
        return await loop.run_in_executor(None, self.analyze_code_files, file_contents, repo_url, prd_content)
